      ...
      module Front
        class AppointmentTest < Minitest::Test
          ...
          def test_find_available_slots
            stub_pike13_request(:get, "/front/appointments/123/available_slots", scope: "front", response_body: {
                                  "available_slots" => [
          ...
          def test_available_slots_summary_with_range_error
            ...
            full_url = "#{base_url}/front/appointments/123/available_slots/summary?from=2020-01-20&to=2021-01-20"
