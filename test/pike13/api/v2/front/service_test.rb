      ...
      module Front
        class ServiceTest < Minitest::Test
          ...
          def test_all_services
            stub_pike13_request(:get, "/front/services", scope: "front", response_body: {
                                  "services" => [{ "id" => 1 }]
                                })
          ...
          def test_find_service
            stub_pike13_request(:get, "/front/services/123", scope: "front", response_body: {
                                  "services" => [{ "id" => 123 }]
                                })
          ...
          def test_enrollment_eligibilities
            stub_pike13_request(:get, "/front/services/123/enrollment_eligibilities", scope: "front", response_body: {
