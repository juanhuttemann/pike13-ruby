      ...
      module Front
        class PlanProductTest < Minitest::Test
          ...
          def test_all_plan_products
            stub_pike13_request(:get, "https://test.pike13.com/api/v2/front/plan_products", response_body: {
                                  "plan_products" => [{ "id" => 1 }]
                                })
          ...
          def test_find_plan_product
            stub_pike13_request(:get, "https://test.pike13.com/api/v2/front/plan_products/123", response_body: {
