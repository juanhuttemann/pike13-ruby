      ...
      module Desk
        class InvoiceTest < Minitest::Test
          ...
          def test_all_invoices
            stub_pike13_request(:get, "/desk/invoices", scope: "desk", response_body: {
                                  "invoices" => [
          ...
          def test_find_invoice
            stub_pike13_request(:get, "/desk/invoices/123", scope: "desk", response_body: {
          ...
          def test_payment_methods
            invoice = Pike13::API::V2::Desk::Invoice.new(session: @client, id: 123)

            stub_pike13_request(:get, "/desk/invoices/123/payment_methods", scope: "desk", response_body: {
