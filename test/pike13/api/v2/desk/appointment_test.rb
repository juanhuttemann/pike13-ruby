      ...
      module Desk
        class AppointmentTest < Minitest::Test
          ...
          def test_find_available_slots
            stub_pike13_request(:get, "https://test.pike13.com/api/v2/desk/appointments/123/available_slots",
                                response_body: {
                                  "available_slots" => [
          ...
          def test_available_slots_summary
            stub_pike13_request(:get, "https://test.pike13.com/api/v2/desk/appointments/123/available_slots/summary",
                                response_body: {
                                  "2020-01-17" => 1.0,
                                  "2020-01-18" => 0,
                                  "2020-01-19" => 0.5
