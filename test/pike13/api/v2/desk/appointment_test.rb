      ...
      module Desk
        class AppointmentTest < Minitest::Test
          ...
          def test_find_available_slots
            stub_pike13_request(:get, "/desk/appointments/123/available_slots", scope: "desk", response_body: {
                                  "available_slots" => [
            ...
            slots = @client.desk.appointments.find_available_slots(service_id: 123)
          ...
          def test_available_slots_summary
            stub_pike13_request(:get, "/desk/appointments/123/available_slots/summary", scope: "desk", response_body: {
                                  "2020-01-17" => 1.0,
                                  "2020-01-18" => 0,
                                  "2020-01-19" => 0.5
                                })

            summary = @client.desk.appointments.available_slots_summary(service_id: 123)
          ...
          def test_available_slots_summary_with_range_error
            ...
            error = assert_raises(Pike13::ValidationError) do
              @client.desk.appointments.available_slots_summary(
                service_id: 123,
                from: "2020-01-20",
                to: "2021-01-20"
              )
