      ...
      module Desk
        class ServiceTest < Minitest::Test
          ...
          def test_all_services
            ...
            services = Pike13::API::V2::Desk::Service.all
          ...
          def test_enrollment_eligibilities
            stub_pike13_request(:get, "https://test.pike13.com/api/v2/desk/services/123/enrollment_eligibilities",
                                response_body: {
            ...
            result = Pike13::API::V2::Desk::Service.enrollment_eligibilities(service_id: 123)
